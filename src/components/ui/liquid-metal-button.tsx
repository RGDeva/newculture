    ...
    <div className="relative inline-block">
      <div style={{ perspective: "1000px", perspectiveOrigin: "50% 50%" }}>
        ...
        >
          ...
          >
            {viewMode === "icon" && (
              <Sparkles size={16} style={{ color: "#666666", filter: "drop-shadow(0px 1px 2px rgba(0,0,0,0.5))" }} />
            )}
            {viewMode === "text" && (
              <span style={{
                fontSize: "14px", color: "#666666", fontWeight: 400,
          ...
          >
            <div style={{
              ...
              boxShadow: isPressed
                ...
                : isHovered
                  ? "0px 0px 0px 1px rgba(0,0,0,0.4), 0px 12px 6px 0px rgba(0,0,0,0.05)"
                  : "0px 0px 0px 1px rgba(0,0,0,0.3), 0px 36px 14px 0px rgba(0,0,0,0.02), 0px 9px 9px 0px rgba(0,0,0,0.12)",
              ...
              <div
                ...
                style={{
                  ...
                  width: `${dimensions.shaderWidth}px`, maxWidth: `${dimensions.shaderWidth}px`,
